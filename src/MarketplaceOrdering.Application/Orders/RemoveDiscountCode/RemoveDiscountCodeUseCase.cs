...
public sealed class RemoveDiscountCodeUseCase
{
    private readonly IOrderRepository _repository;
    private readonly IClock _clock;

    public RemoveDiscountCodeUseCase(IOrderRepository repository, IClock clock)
    {
        ...
        CancellationToken cancellationToken)
    {
        ...
        var changed = loaded.Value.Order.RemoveDiscountCode(_clock.UtcNow);
